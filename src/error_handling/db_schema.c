...
{
    { SENSORID_FNO,     "sensorid",        DB_COLTYPE_SINT32,      0,                0, DB_NOT_NULL, 0 },
    { PACKETID_FNO,     "packet",          DB_COLTYPE_SINT64,      0,                0, DB_NOT_NULL, 0 },
    { TIMEPOINT_FNO,    "timepoint",       DB_COLTYPE_TIMESTAMP,   0,                0, DB_NOT_NULL, 0 },
    { TEMPERATURE_FNO,  "temperature",     DB_COLTYPE_FLOAT64,     0,                0, DB_NULLABLE, 0 },
};
